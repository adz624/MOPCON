...
<head>
	...
	<title>議程表 | 行動科技應用開發者年會 | MOPCON 2014 | Mobile / Open / Platform Conference</title>
	<meta content="議程表 | 行動科技應用開發者年會 | MOPCON 2014 | Mobile / Open / Platform Conference" property="og:title">
    ...
    <article class="area-all" href="#inline_content">
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/../sponsor/asuscloud.png">
            </figure>
            <h3>Asus Cloud</h3>
            <h2><a href="#">ASUS Cloud 贊助抽獎活動</a></h2>
            <div class="detail">
...
<div class="row">
    ...
    <article class="area-all" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>吳漢章 (Peter Wu)</h3>
            <h2><a href="#">ASUS Cloud &amp; the API enabled solutions</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-1" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>Drake (官順暉)</h3>
            <h2><a href="#">How does Netflix get built and triumphed?</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
這是我想與你們分享並討論的議題～</p>
    ...
    <article class="area-2" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>上官林傑 (ericsk)</h3>
            <h2><a href="#">使用 Microsoft Azure 雲端平臺規劃及建置高延展、高可靠性的應用系統</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
講題標語: 快速、可靠、穩定的應用程式</p> 
    ...
    <article class="area-3" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>徐德航</h3>
            <h2><a href="#">面對贏者全拿的APP市場開發者該怎麼成功 - 以 APP 手機遊戲市場為例</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-1" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h2><a href="#">Make Your Next App 🎉👏😄💘👍</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
    ...
    <article class="area-2" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h2><a href="#">how Xamarin.Android works</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
    ...
    <article class="area-3" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>James Tien</h3>
            <h2><a href="#">Building Mobile Apps on AWS</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-1" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>kewang</h3>
            <h2><a href="#">How to build a scalable SNS via Polling &amp; Push</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
 API Blueprint：分享前後端如何撰寫簡單的Markdown就能成功串接API。</p>
    ...
    <article class="area-2" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>Joe</h3>
            <h2><a href="#">講個秘訣之：離開新手村後也可以順便聽一下的程式「設計」指南</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
 聽眾群：建議有兩年以上程式設計經驗</p>
    ...
    <article class="area-3" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>鄭鎧尹 (Keynes)</h3>
            <h2><a href="#">Think in Internet</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-all" href="#inline_content">
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/../sponsor/../index-logo.svg">
            </figure>
            <h3>微軟公司與華碩雲端</h3>
            <h2><a href="#">議程有獎問答</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-1" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>Peter Tseng</h3>
            <h2><a href="#">群眾資料能拿來做什麼？淺談Machine Learning技術於Smart Mobile Computing的應用</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
    ...
    <article class="area-2" href="#inline_content">
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/../sponsor/yahoo.png">
            </figure>
            <h3>Yahoo</h3>
            <h2><a href="#">Rational, Emotional, and Meaningful Design</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
    ...
    <article class="area-3" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>何志恒</h3>
            <h2><a href="#">制霸行動戰場，完美跨平台行動開發</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
服務才正要上場。</p>
    ...
    <article class="area-2" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>Vincent Chen</h3>
            <h2><a href="#">一個意外、兩個現實、三個心得～談『猜猜巧克力』的開發旅程</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
    ...
    <article class="area-3" href="#inline_content">
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/../sponsor/synology_dark_bg.png">
            </figure>
            <h3>群暉科技</h3>
            <h2><a href="#">愛上雲端: 如何建立便捷私有雲</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-1" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>imsardine</h3>
            <h2><a href="#">利用 Appium + Robot Framework 實現跨平台 App 互動測試</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
    ...
    <article class="area-3" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>謝耀輝 (John Sie)</h3>
            <h2><a href="#">台灣與海外網路創業之差異與經驗談</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-1" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h2><a href="#">以小勝大 - 從 Firefox 瀏覽器到 Firefox OS</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
    ...
    <article class="area-2" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>張景隆</h3>
            <h2><a href="#">in in der 響應式編程</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
Mattt大神說「ReactiveCocoa 是 Objective-C 的新紀元」 Justin DeWind「ReactiveCocoa 將是 Cocoa 的未來」</p>
    ...
    <article class="area-3" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h2><a href="#">《Tengami》遊戲成功經驗分享與開發者將作品打進日本市場的可用資源</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-all" href="#inline_content">
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/../sponsor/ms.jpg">
            </figure>
            <h3>Microsoft</h3>
            <h2><a href="#">Microsoft 贊助抽獎活動</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-1" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>宋牧奇</h3>
            <h2><a href="#">Bistro貓咪餵食器的群眾募資之路與技術挑戰</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
頑皮的產品開發之路 - 呼叫小黃＆雲端電台</a></h2>
    ...
    <article class="area-3" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>Ernest Chiang</h3>
            <h2><a href="#">如何面對 O2O 線上與實體的挑戰？</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<div class="row">
    ...
    <article class="area-1" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>Anistar (宋志峰)</h3>
            <h2><a href="#">架構做的巧，APP沒煩惱 – 談如何建立彈性又好維護的軟體架構</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
    ...
    <article class="area-2" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>Peni</h3>
            <h2><a href="#">千里之行，始於足下：動手寫自己的App</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
    ...
    <article class="area-3" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>廖聰哲 (Ian Liao)</h3>
            <h2><a href="#">Golface VS. 精實創業</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
...
<time>13:15~13:55</time>
<div class="row">
    <a name="2014/10/26_13:15~13:55_一廳"></a>
    <article class="area-1" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">一廳</span>
            <span class="btn" style="background-color:blue">技術</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/eddie.jpg">
            </figure>
            <h3>高見龍</h3>
            <h2><a href="#">你可能已經知道，但也可能還不知道的 Swift</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">Swift 是由 Apple 今年所新推出的程式語言，它的設計是參考自好幾種近代的程式語言。雖然第一眼看起來 Swift 似乎很好學，但事實上並沒有想像中的容易。本次演講將介紹一些大家可能在官網文件不會特別留意但挺有趣的細節或陷阱，並將介紹如何使用 Functional Programming 的思考方式來幫忙整理程式碼。</p>
                <p class="title">講者簡介</p>
                <p class="introduce">高見龍，兩個小朋友的爸爸。目前靠 Ruby/Rails/iOS app 開發以及研磨紅寶石糊口渡日。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
    ...
    <a name="2014/10/26_13:15~13:55_二廳"></a>
    <article class="area-2" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">二廳</span>
            <span class="btn" style="background-color:green">營運</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/jarsing.jpg">
            </figure>
            <h3>陳佳新</h3>
            <h2><a href="#">只要2天，你也可以贏得APP競賽佳作！</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">奇步應用是一個專注於 APP 開發的新創團隊，除了接案，也參加了不少競賽。兩位創辦人一人負責程式開發、一人負責美術設計，白天均有一份正職工作，只有晚上和假日有時間經營工作室，而且身邊還總是伴隨著兩位 3 歲和 1 歲半的幼兒。但是他們獲得 Samsung Smart App Challeng 2014 佳作的 APP，從企劃、開發到簡報竟然只花了 2 天的時間。這無疑是精實創業精神的極致表現。本議程將從技術層面探討快速開發 Android App 的流程（從套用買來的 template 開始，到做出 MVP），再搭配經營層面的經驗分享（例如如何讓企劃書通過初審，融入 PMF 訴求）。</p>
                <p class="title">講者簡介</p>
                <p class="introduce">接觸程式設計的年齡跟Tesla電動車老闆馬斯克差不多，都是11、12歲。熱中於投稿電腦雜誌與翻譯電腦書籍，譯作包括歐萊禮的《Programming Android》。在軟體業打滾了7年。於2013年5月與妻子共同創辦奇步應用工作室，專注於APP開發。iOS作品曾於2013年被網路公司收購。Android作品在2014年分別榮獲Samsung Smart App Callenge挑戰賽佳作以及經濟部工業局Open Data創新應用競賽特優。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
    ...
    <a name="2014/10/26_13:15~13:55_三廳"></a>
    <article class="area-3" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">三廳</span>
            <span class="btn" style="background-color:blue">技術</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/johnny.jpg">
            </figure>
            <h3>宋岡諺 (Johnny Sung)</h3>
            <h2><a href="#">Google Glass 開發經驗分享</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">全台灣大約只有20隻！從Google眼鏡問世，開始出現了「穿戴式」的應用的分類 想知道Google眼鏡要怎麼開發？會有什麼樣有趣的應用？實作Glassware上架有什麼重點？一一報給您知！ 

大綱：
 Google glass 的簡介
 Mirror API 初探
 10分鐘快速上手 GDK (Glass Development Kit) 開發
 Glassware上架審核重點
 Google glass 與 Android wear 的異同之處</p>
                <p class="title">講者簡介</p>
                <p class="introduce">目前是Hiiir(時間軸科技)的一名小小工程師 主要在於手機端的 iOS / Android 開發，無意間拿到一隻公司的Google glass， 才好好認識什麼叫做「穿戴式」裝置，揭開一連串有趣的應用</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
...
<time>13:55~14:20</time>
<div class="row">
    <a name="2014/10/26_13:55~14:20_全部"></a>
    <div style="color:#fff; background-color:#69CA62; padding:3px; text-align:center;">
      <div>休息時間</div>
      <div style="color:#eee"></div>
    </div>
...
<time>14:20~15:00</time>
<div class="row">
    <a name="2014/10/26_14:20~15:00_一廳"></a>
    <article class="area-1" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">一廳</span>
            <span class="btn" style="background-color:blue">技術</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/pichu.jpg">
            </figure>
            <h3>Pichu Chen</h3>
            <h2><a href="#">Maid White － 一個懂得控制所有智慧家電的女僕</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">在不久的將來，我們會用手機或者是各種穿戴式裝置來控制我們現有的家電。 然而，我們將會面臨因為不同的廠牌無法相容所帶來的不便。 Maid White為此而生。 透過Maid White，我們可以透過單一平台來操作市面上絕大多數的智慧家電。 更令人興奮的是，Maid White API將可以使開發者利用軟體的方式，定義這些智慧家電的行為。</p>
                <p class="title">講者簡介</p>
                <p class="introduce">TIH是個致力於推動台灣家庭自動化以及建立軟體產業鏈的團隊。 藉由主動學習各個智慧家電的通訊方式，並重新放出Open API來達成此一目標。 團隊成員來自中山大學CDPA，是個維護近四千名住宿生網路的學生組織。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
    ...
    <a name="2014/10/26_14:20~15:00_二廳"></a>
    <article class="area-2" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">二廳</span>
            <span class="btn" style="background-color:blue">技術</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/virus.jpg">
            </figure>
            <h3>小璋丸 (吳政璋)</h3>
            <h2><a href="#">鐵人碼表 DIY</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce"> Android 整合 Bluetooth Smart 與 ANT+ 運動感應器
 Bluetooth 與 ANT+ 競爭力比較
 App 成果展示與支援哪些玩具
 台灣發展門檻</p>
                <p class="title">講者簡介</p>
                <p class="introduce">我是個小小程序員，本行從事網路安全， 除了寫程式，也愛好長笛和三鐵， 自從陷入三鐵的無窮敗家迴圈後，開始研究相關的行動應用， 目前正在努力整合各種運動與健康的裝置， 希望可以完成一個神祕的計畫。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
    ...
    <a name="2014/10/26_14:20~15:00_三廳"></a>
    <article class="area-3" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">三廳</span>
            <span class="btn" style="background-color:blue">技術</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/KenChan.jpg">
            </figure>
            <h3>Ken Chan</h3>
            <h2><a href="#">Developing Mobile apps with AWS</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">Learn about AWS' latest portfolio of mobile optimized services. Whether you are a mobile developer topping the charts in the app store, or a business trying to be &quot;Mobile-first&quot;, the cloud is a critical part of your solution, enabling you to build fast and scale easily. This session will help you understand how to leverage the full power of the AWS Cloud Platform offering in your mobile apps.

Do you aspire to quickly build a mobile app or game and deliver engaging experiences to millions of users? Learn how to get started with AWS Mobile Services. This session will introduce the essential building blocks of a cloud-backed mobile app. The session will provide an overview of AWS Mobile Services and Connectors included in the AWS Mobile SDK and demonstrate how you can leverage these to deliver engaging experiences in your app.</p>
                <p class="title">講者簡介</p>
                <p class="introduce">Ken在IT界擁有+15年的資深經驗，曾經在Red Hat擔任大中華地區的方案架構經理並領導著頂尖科技團隊與政府合作開發各樣FSI，Telco相關的解決方案，協助銷售團隊去穩定和提升商機。
            Ken在2011年加入AWS，推廣AWS雲端服務並提供AWS技術專業指導，幫助用戶快速上手。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
...
<time>15:00~15:20</time>
<div class="row">
    <a name="2014/10/26_15:00~15:20_全部"></a>
    <div style="color:#fff; background-color:#69CA62; padding:3px; text-align:center;">
      <div>休息時間</div>
      <div style="color:#eee"></div>
    </div>
...
<time>15:20~16:00</time>
<div class="row">
    <a name="2014/10/26_15:20~16:00_一廳"></a>
    <article class="area-1" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">一廳</span>
            <span class="btn" style="background-color:blue">技術</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/superbil.jpg">
            </figure>
            <h3>Superbil</h3>
            <h2><a href="#">How to make a iOS 8 touch framework.</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">從 iOS 8 開始， Apple 終於讓開發者可以自行開發屬於自己的函式庫。這個開發方式和以往的有那些地方需要注意，還有那些應該準備好的流程。 本次演講會提及一些使用上及實作上的細節，流程會是其中主要介紹的方向。</p>
                <p class="title">講者簡介</p>
                <p class="introduce">喜愛 Cocoa 框架的熱血工程師，從事 iOS 開發三年，對於新奇事物充滿好奇心、對於 cocoa 喜歡的原因，最近也開始研究起咖啡來。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
    ...
    <a name="2014/10/26_15:20~16:00_二廳"></a>
    <article class="area-2" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">二廳</span>
            <span class="btn" style="background-color:green">營運</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/ant.jpg">
            </figure>
            <h3>ant</h3>
            <h2><a href="#">App 及 Maker 開發者防身術：如何保護您的心血大作</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">本議程將討論 App 及 Maker 所面臨的法律風險。佐以案例探討如何臨摹他人作品免於侵權？如何保護自身作品免於山寨？以及如何運用有效成本進行矛與盾的攻防。</p>
                <p class="title">講者簡介</p>
                <p class="introduce">目前專注於「合法的安全程式設計」。在「自由/開放源碼」「資訊安全」及「程式設計」領域擁有數場公開及非公開的教育訓練課程和演講，同時撰寫 過數篇發明專利。閒暇時喜歡沉浸在「心理學」及「經濟學」的世界，並時常穿梭於「人性」、「法律」與「科技」的三角關係中。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
    ...
    <a name="2014/10/26_15:20~16:00_三廳"></a>
    <article class="area-3" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">三廳</span>
            <span class="btn" style="background-color:blue">技術</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/BrianWang.jpg">
            </figure>
            <h3>Brian Wang</h3>
            <h2><a href="#">行動平台玩音樂 - 快速開發iOS高效能專業音樂App！ (Modern Audio App Development on iOS)</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">在此演說中，將會介紹目前iOS平台上的專業音樂軟體風向、ecosystem介紹與必備觀念，如何在iOS平台上利用Audiobus與Amazing Audio Engine快速開發各類型的有趣好玩音樂App，以及開發高效能專業音樂App不可不知的祕訣。</p>
                <p class="title">講者簡介</p>
                <p class="introduce">同時具備Maker精神以及對音樂的熱情於一身，Brian堅信行動裝置對未來音樂人有著不可或缺的重要性。從來沒停止過結合音樂科技與行動裝置、開放硬體與雲端服務，做各式各樣的嘗試與開發，將成果實際帶入自己的表演活動中使用，以享受自己的實作成果為樂。在2011年起就與Positive Grid團隊合作，研發出JamUp, BIAS, Final Touch等iOS平台上的專業吉他效果與音樂音訊處理軟體，不僅取得市場上的成功，在美國iTunes Store Music App 熱門付費與利潤排行上持續名列前茅，產品也受到使用者與專業音樂媒體的一致好評，在全世界累計已超過百萬使用者。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
...
<time>16:00~16:20</time>
<div class="row">
    <a name="2014/10/26_16:00~16:20_全部"></a>
    <div style="color:#fff; background-color:#69CA62; padding:3px; text-align:center;">
      <div>休息時間</div>
      <div style="color:#eee"></div>
    </div>
...
<time>16:20~17:00</time>
<div class="row">
    <a name="2014/10/26_16:20~17:00_一廳"></a>
    <article class="area-1" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">一廳</span>
            <span class="btn" style="background-color:blue">技術</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/ElvisLin.jpg">
            </figure>
            <h3>Elvis Lin</h3>
            <h2><a href="#">Use Testing to Rock Your Android Application</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">幾乎所有開發者都不會否定軟體測試的重要性，但是在專案開發中推動測試似乎又不是一件容易的事。 本次講題以 JUnit、Android testing framework 與 Calabash-android 結合 CI，提供一個簡明的步驟讓所有的開發者可以用輕鬆的方式享受到測試的好處。</p>
                <p class="title">講者簡介</p>
                <p class="introduce">目前在 Gash+ 中進行 Android 軟體開發的工作。最新的興趣是將測試加入開發的流程中，偶爾會發生一個不小心測試的程式碼比被測試的程式碼還長的「意外」。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
    ...
    <a name="2014/10/26_16:20~17:00_二廳"></a>
    <article class="area-2" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">二廳</span>
            <span class="btn" style="background-color:blue">技術</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/tsaikd.jpg">
            </figure>
            <h3>tsaikd (蔡程豐)</h3>
            <h2><a href="#">大規模網路服務管理的起點 (Docker &amp; Consul)</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">利用輕量型的虛擬化技術 - Docker - 可快速佈署大量網路服務，該如何管理大量的服務就變成另一項重要的工作，Consul (http://www.consul.io/) 就是用來解決服務散落各地的問題，它透過 DNS 可讓使用者查詢網路服務的位置，另外還有提供 REST API 可提供更多的客製化功能。</p>
                <p class="title">講者簡介</p>
                <p class="introduce">Tsai KD，宅宅工程師，熱衷學習各種新技術，從前端到後端都稍有涉獵，除了一些常見的程式語言之外，目前較關注 Go 語言；系統方面，自從 Docker 出現後，就把 VM 當成備胎了...XD 目前待的公司主要營業項目是專利相關業務，對於專利資料的處理有幾年的經驗。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
    ...
    <a name="2014/10/26_16:20~17:00_三廳"></a>
    <article class="area-3" href="#inline_content">
        <div class="place">
            <span class="btn btn-blue">三廳</span>
            <span class="btn" style="background-color:green">營運</span>
        ...
        <div class="talker">
            <figure style="overflow:hidden;">
                        <img style="width:auto; height:auto;" src="images/speakers/MuFan.jpg">
            </figure>
            <h3>鄧慕凡</h3>
            <h2><a href="#">使用 Sinatra 結合 Ruby on Rails 輕鬆打造完整 Full Stack 網站加 API Service服務</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">介紹如何使用 Sinatra 打造高效輕量的 Mobile App 後端 API 服務，以及結合 Ruby on Rails 製作後台服務（Backend Console）的方法</p>
                <p class="title">講者簡介</p>
                <p class="introduce">鄧慕凡, 1997年開始遊戲業十年生涯, 2007年開始網站創業; 除了經營台灣最大車友社群 FSC 以及台灣免費論壇系統 FREEBBS.TW 外，也是五倍紅寶石股份有限公司的共同創辦人; 工作之餘也積極經營Ruby語言社群, 現為台灣 Ruby程式語言社群「Ruby Taiwan」, 年度國際研討會「RubyConf Taiwan」以及Railsgirls Taipei 工作坊的主辦人。</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
...
<div class="row">
    ...
    <article class="area-all" href="#inline_content">
        ...
        <div class="talker">
            ...
            <h3>全體會眾</h3>
            <h2><a href="#">閃電講 (Lightning Talk)</a></h2>
            <div class="detail">
                <p class="title">議題介紹</p>
                <p class="introduce">由參與者報名進行五分鐘的即席演講。</p>
                <p class="title">講者簡介</p>
                <p class="introduce">參與 Mopcon 的全體會眾</p> 
                <a href="#" class="jq-close">
                    <i class="icon-cross3"></i>
                </a>
            </div>
