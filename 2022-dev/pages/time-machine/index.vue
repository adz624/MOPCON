    ...
    <main>
      ...
      <section>
        <div class="info">
          <div class="slider">
            <img
              src="~/assets/images/triangle-pointed-up.svg"
              alt="pointed-up"
              class="mb-3"
              @click="onLastSlide"
            >
            <Splide ref="slider" :options="splideOptions">
              <SplideSlide v-for="year in years" :key="year">
                {{ year }}
              </SplideSlide>
            </Splide>
            <img
              src="~/assets/images/triangle-pointed-down.svg"
              alt="pointed-down"
              class="mt-3"
              @click="onNextSlide"
            >
...
.time-machine {
  ...
  .banner {
    ...
    .image {
      height: 568px;
      background: url('~/assets/images/banner-pc.webp') no-repeat center center / cover;
    }
  }
