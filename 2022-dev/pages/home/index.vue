      ...
      <div class="container mo-area">
        <div class="mo-content">
          ...
          <div class="btn-area mt-6 mt-md-8">
            ...
            <div class="btn btn-primary" @click="openWindow('./mosume')">
  ...
  data () {
    return {
      ...
      sponsorLogoList: [
        ...
        'assets/images/home/logo_banner_18.png?v=2',
        'assets/images/home/logo_banner_19.png?v=2',
        'assets/images/home/logo_banner_20.png?v=2'
      ]
    }
  },
  computed: {
