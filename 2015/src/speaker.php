...
function getAllSpeakers()
{
    return [
        ...
        'benjai' => [
            'name' => '翟本喬 (Ben Jai)',
            'pic' => 'speaker/benjai.jpg',
            'title' => '和沛科技 創辦人暨總經理',
            'bio' => "翟本喬為台灣第一位跳級生，1999 年赴美取得紐約大學電腦科學博士，2003 年進入 Google，成功研發高效率單電壓電源供應器。2010 年回到台灣加入台達電子創立雲端技術中心。2013 年 6 月率原團隊成立和沛科技，積極開發符合雲端運算精神的新產品及服務，並對於台灣創新創業環境多有建言。",
            'links' => [
        ...
        'muki' => [
            'name' => '吳姿穎 (Muki)',
            'pic' => 'speaker/muki.jpg',
            'title' => '拾木空間 總兼',
            'bio' => "拾木空間總兼，經營文具社群與文具銷售，同時也是網站設計師與講師。<br>著作包含 2 本 WordPress 書、1 本手帳整理術，以及譯作 2 本 WordPress 書。<br>喜愛推廣與學習 HTML, CSS, 與 jQuery，興趣是在跨界與自我挑戰中成長，從事過設計、前端、行銷與專案管理等工作。",
            'links' => [
        ...
        'blue' => [
            'name' => '陳柏儒 (Blue)',
            'pic' => 'speaker/blue.jpg',
            'title' => '聯發科技 MTK 前端工程師',
        ...
        'kny' => [
            ...
            'pic' => 'speaker/kny.jpg',
            'title' => 'KNY Co. 執行長',
            'bio' => "<ul><li>KNY Co. 執行長</li><li>中華民國 App 跨界交流協會 理事長</li><li>台灣開放資料聯盟App組 召集人</li><li>交通部資料開放諮詢小組 諮詢委員</li><li>曾獲 Google Play 頂尖開發人員徽章</li></ul>國小開始 Coding，全端獨立開發超過 10 年，長期關注與推動台灣 App 與 Open Data 的發展。希望能透過科技與開放的力量，改善社會問題與建構更美好的未來",
            'links' => [
            ],
        ],
        'jeremy' => [
            'name' => 'Jeremy Lu',
            'pic' => 'speaker/jeremy.jpg',
        ...
        'akane' => [
            'name' => 'Akane Lee',
            'pic' => 'speaker/akane.jpg',
            'title' => 'Madders 創辦人',
            'bio' => "嫁給 RD 的 UI Designer",
            'links' => [
        ...
        'yccsonar' => [
            'name' => '張逸中',
            'pic' => 'speaker/yccsonar.jpg',
            'title' => '逸中軟體設計有限公司 執行長',
