<html lang="zh-TW" class="">
  <head>
      <meta charset="utf-8">
    <title>MOPCON 2013 | Mobile Open Platform Conference's Call For Papers!</title>
    <!--[if lt IE 9]>
      <script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
    <![endif]-->
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="MOPCON 2013 | Mobile Open Platform Conference's Call For Papers!" property="og:title">
    <meta content="http://mopcon.org/2013/cfp_en.php" property="og:url">
    <meta content="MOPCON 2013 | Please come and share your experience and thinking about mobile application development at MOPCON!" property="og:description">
    ...
    <div class="navbar-inner">
        ...
        <div class="nav-collapse">
          <ul class="nav">
            ...
            <li class="active"><a href="cfp_en.php">Call for Papers</a></li>
