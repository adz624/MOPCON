...
<html lang="zh-TW" class="">
  ...
  <body data-twttr-rendered="true" data-spy="scroll" data-target=".subnav" data-offset="50">
    ...
    <div class="container" id="all">
      <div class="space"></div>
      <div class="article">
        <div id="irc" class="offset1 span10 second well-large">
          <div class="ircframe">
            <h3>加入IRC聊天頻道</h3>
            <div style="text-align:center; vertical-align:middle;">
              <iframe src="http://webchat.freenode.net?channels=mopcon&uio=d4" width="600" height="600" style="border: 0;"></iframe>
            </div>
          </div>
          <div class="irclogs">
            <h3>活動實況文字轉播記錄</h3>
