<html lang="zh-TW" class="">
  <head>    <meta charset="utf-8">
    <title>MOPCON 2013 | IRC</title>
    <!--[if lt IE 9]>
      <script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
    <![endif]-->
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="MOPCON 2013 | IRC" property="og:title">
    <meta content="http://mopcon.org/2013/irc.php" property="og:url">
    <meta content="MOPCON 2013 | MOPCON IRC Channel" property="og:description">
    <meta content="http://mopcon.org/img/snapshot.jpg" property="og:image">
    <meta content="website" property="og:type">
    <meta content="MOPCON 2013 | IRC" property="og:site_name">
    ...
    <div class="navbar-inner">
        ...
        <div class="nav-collapse">
          <ul class="nav">
            ...
            <li class="active"><a href="irc.php">IRC</a></li>
        ...
        <div id="irc" class="span10 second well-large">
          <div class="row ircframe">
            <div class="span9">
              ...
              <p><a class="btn btn-success btn-large" rel="external" target="_blank" href="http://webchat.freenode.net?channels=mopcon&uio=d4">加入頻道討論</a></p>
              <p>&nbsp;&nbsp;</p>
            </div>
          </div>
          <div class="row ircframe">
