	...
	<div id="aboutUs">
		...
		<div class="section">
			...
			<div class="popover bottom">
				...
				<div class="popover-content">
					<p>台南開放原始碼系統使用者聚會</p>
                    <p><a href="https://code.google.com/p/mosut/">官方網站</a></p>
                </div>
			</div>
        </div>
		<div class="section">
		...
		<div class="section">
			<p class="myLogo"><a class="thumbnail" href="http://www.facebook.com/kalug.tw"><img src="img/kalug.jpg" alt="KaLut logo"></a></p>
			<div class="popover bottom">
				<div class="arrow">&nbsp;</div>
