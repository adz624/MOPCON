            ...
            <div class="span7">
              <h3>報名資訊</h3>
                <ul class="sessionList">
		          ...
		          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-success btn-large" rel="external">報名截止</a></p>
              <p><a class="btn btn-info btn-large" rel="external" target="_blank" href="2013/MOPCON-2013-Manual.pdf">大會手冊</a></p>
            </div>
          </div>
        </div>
        <div class="row">
